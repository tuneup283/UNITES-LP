...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    isset($data['message']) && count($error_message) == 0) {
        ...
        // メールの送信 
        $to = "yasunori_tanouchi@icloud.com";
        // 送信先のメールアドレスを指定 
...
<head>
    ...
    <link rel="stylesheet" href="../css/main.css?202403091854">
    <!-- JS -->
...
<body id="top">
            ...
            <div class="header-nav__content">
                ...
                <div class="tab-full">
                    <div class="header-nav-bottom">
                        <div class="mail"><span>MAIL</span>info@mail.com</div>
                        <div class="tel"><span>TEL</span>090-1234-567</div>
                    </div>
        ...
        <div class="row footer-side">
            <div class="tab-full footer-side-item footer-subscribe">
                <div class="footer-side-contact pc-only">
                    <div class=""><span>MAIL</span>info@mail.com</div>
                    <div class="_line"></div>
                    <div class="tel"><span>TEL</span>090-1234-567</div>
                </div>
    ...
    <script src="../js/contact.js?202403121814"></script>
</body>
</html>